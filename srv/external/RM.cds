/* checksum : 820a3a13b1aa96a7741764c6d905ff56 */
@cds.external : true
...
entity RM.A_AddressEmailAddress {
...
entity RM.A_AddressHomePageURL {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Address Number'
  key AddressID : String(10) not null;
  @sap.display.format : 'UpperCase'
...
entity RM.A_AddressPhoneNumber {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Address Number'
  key AddressID : String(10) not null;
  @sap.display.format : 'UpperCase'
...
entity RM.A_BPAddrDepdntIntlLocNumber {
  @sap.display.format : 'UpperCase'
...
entity RM.A_BPAddressIndependentEmail {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Business Partner'
  @sap.quickinfo : 'Business Partner Number'
  key BusinessPartner : String(10) not null;
...
entity RM.A_BPAddressIndependentFax {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Business Partner'
  @sap.quickinfo : 'Business Partner Number'
  key BusinessPartner : String(10) not null;
...
entity RM.A_BPAddressIndependentMobile {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Business Partner'
  @sap.quickinfo : 'Business Partner Number'
  key BusinessPartner : String(10) not null;
...
entity RM.A_BPAddressIndependentPhone {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Business Partner'
  @sap.quickinfo : 'Business Partner Number'
  key BusinessPartner : String(10) not null;
...
entity RM.A_BPAddressIndependentWebsite {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Business Partner'
  @sap.quickinfo : 'Business Partner Number'
  key BusinessPartner : String(10) not null;
...
entity RM.A_BPContactToAddress {
  @sap.display.format : 'UpperCase'
  ...
  to_EmailAddress : Association to many RM.A_AddressEmailAddress {  };
  to_FaxNumber : Association to many RM.A_AddressFaxNumber {  };
  to_MobilePhoneNumber : Association to many RM.A_AddressPhoneNumber {  };
  to_PhoneNumber : Association to many RM.A_AddressPhoneNumber {  };
  to_URLAddress : Association to many RM.A_AddressHomePageURL {  };
};
...
entity RM.A_BPContactToFuncAndDept {
  @sap.display.format : 'UpperCase'
  @sap.label : 'BP Relationship No.'
  @sap.quickinfo : 'BP Relationship Number'
  key RelationshipNumber : String(12) not null;
...
entity RM.A_BPCreditWorthiness {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Business Partner'
  @sap.quickinfo : 'Business Partner Number'
  key BusinessPartner : String(10) not null;
...
entity RM.A_BPFinancialServicesExtn {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Business Partner'
  @sap.quickinfo : 'Business Partner Number'
  key BusinessPartner : String(10) not null;
...
entity RM.A_BPFinancialServicesReporting {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Business Partner'
  @sap.quickinfo : 'Business Partner Number'
  key BusinessPartner : String(10) not null;
...
entity RM.A_BPFiscalYearInformation {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Business Partner'
  @sap.quickinfo : 'Business Partner Number'
  key BusinessPartner : String(10) not null;
...
entity RM.A_BPIntlAddressVersion {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Business Partner'
  @sap.quickinfo : 'Business Partner Number'
  key BusinessPartner : String(10) not null;
...
entity RM.A_BuPaIdentification {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Business Partner'
  @sap.quickinfo : 'Business Partner Number'
  key BusinessPartner : String(10) not null;
...
entity RM.A_BusinessPartner {
  ...
  @sap.quickinfo : 'Company ID of Trading Partner'
  TradingPartner : String(6);
  to_AddressIndependentEmail : Association to many RM.A_BPAddressIndependentEmail {  };
  to_AddressIndependentFax : Association to many RM.A_BPAddressIndependentFax {  };
  to_AddressIndependentMobile : Association to many RM.A_BPAddressIndependentMobile {  };
  to_AddressIndependentPhone : Association to many RM.A_BPAddressIndependentPhone {  };
  to_AddressIndependentWebsite : Association to many RM.A_BPAddressIndependentWebsite {  };
  to_BPCreditWorthiness : Association to RM.A_BPCreditWorthiness {  };
  to_BPDataController : Association to many RM.A_BPDataController {  };
  to_BPEmployment : Association to many RM.A_BPEmployment {  };
  to_BPFinServicesReporting : Association to RM.A_BPFinancialServicesReporting {  };
  to_BPFiscalYearInformation : Association to many RM.A_BPFiscalYearInformation {  };
  to_BPRelationship : Association to many RM.A_BPRelationship {  };
  to_BuPaIdentification : Association to many RM.A_BuPaIdentification {  };
  to_BuPaIndustry : Association to many RM.A_BuPaIndustry {  };
  to_BusinessPartner : Association to RM.A_BPFinancialServicesExtn {  };
  to_BusinessPartnerAddress : Association to many RM.A_BusinessPartnerAddress {  };
  to_BusinessPartnerAlias : Association to many RM.A_BusinessPartnerAlias {  };
  to_BusinessPartnerBank : Association to many RM.A_BusinessPartnerBank {  };
  to_BusinessPartnerContact : Association to many RM.A_BusinessPartnerContact {  };
  to_BusinessPartnerIsBank : Association to RM.A_BusinessPartnerIsBank {  };
  to_BusinessPartnerRating : Association to many RM.A_BusinessPartnerRating {  };
  to_BusinessPartnerRole : Association to many RM.A_BusinessPartnerRole {  };
  to_BusinessPartnerTax : Association to many RM.A_BusinessPartnerTaxNumber {  };
  to_BusPartAddrDepdntTaxNmbr : Association to many RM.A_BusPartAddrDepdntTaxNmbr {  };
  to_Customer : Association to RM.A_Customer {  };
  to_PaymentCard : Association to many RM.A_BusinessPartnerPaymentCard {  };
  to_Supplier : Association to RM.A_Supplier {  };
};
...
@sap.content.version : '1'
@sap.label : 'Address'
entity RM.A_BusinessPartnerAddress {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Business Partner'
  @sap.quickinfo : 'Business Partner Number'
  key BusinessPartner : String(10) not null;
  ...
  to_AddressUsage : Association to many RM.A_BuPaAddressUsage {  };
  to_BPAddrDepdntIntlLocNumber : Association to RM.A_BPAddrDepdntIntlLocNumber {  };
  to_BPIntlAddressVersion : Association to many RM.A_BPIntlAddressVersion {  };
  to_EmailAddress : Association to many RM.A_AddressEmailAddress {  };
  to_FaxNumber : Association to many RM.A_AddressFaxNumber {  };
  to_MobilePhoneNumber : Association to many RM.A_AddressPhoneNumber {  };
  to_PhoneNumber : Association to many RM.A_AddressPhoneNumber {  };
...
entity RM.A_BusinessPartnerAlias {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Business Partner'
  @sap.quickinfo : 'Business Partner Number'
  key BusinessPartner : String(10) not null;
...
@sap.content.version : '1'
@sap.label : 'Bank'
entity RM.A_BusinessPartnerBank {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Business Partner'
  @sap.quickinfo : 'Business Partner Number'
  key BusinessPartner : String(10) not null;
...
@sap.content.version : '1'
@sap.label : 'Contact'
entity RM.A_BusinessPartnerContact {
  @sap.display.format : 'UpperCase'
  @sap.label : 'BP Relationship No.'
  @sap.quickinfo : 'BP Relationship Number'
  key RelationshipNumber : String(12) not null;
  ...
  @sap.quickinfo : 'Business Partner Relationship Category'
  RelationshipCategory : String(6);
  to_ContactAddress : Association to many RM.A_BPContactToAddress {  };
  to_ContactRelationship : Association to RM.A_BPContactToFuncAndDept {  };
};
...
entity RM.A_BusinessPartnerIsBank {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Business Partner'
  @sap.quickinfo : 'Business Partner Number'
  key BusinessPartner : String(10) not null;
...
entity RM.A_BusinessPartnerPaymentCard {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Business Partner'
  @sap.quickinfo : 'Business Partner Number'
  key BusinessPartner : String(10) not null;
...
@sap.content.version : '1'
@sap.label : 'Ratings'
entity RM.A_BusinessPartnerRating {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Business Partner'
  @sap.quickinfo : 'Business Partner Number'
  key BusinessPartner : String(10) not null;
...
@sap.content.version : '1'
@sap.label : 'Role'
entity RM.A_BusinessPartnerRole {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Business Partner'
  @sap.quickinfo : 'Business Partner Number'
  key BusinessPartner : String(10) not null;
...
entity RM.A_BusinessPartnerTaxNumber {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Business Partner'
  @sap.quickinfo : 'Business Partner Number'
  key BusinessPartner : String(10) not null;
...
entity RM.A_BusPartAddrDepdntTaxNmbr {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Business Partner'
  @sap.quickinfo : 'Business Partner Number'
  key BusinessPartner : String(10) not null;
...
entity RM.A_CustAddrDepdntExtIdentifier {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Customer'
  @sap.quickinfo : 'Customer Number'
...
entity RM.A_CustAddrDepdntInformation {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Customer'
  @sap.quickinfo : 'Customer Number'
  key Customer : String(10) not null;
...
entity RM.A_Customer {
  ...
  to_CustAddrDepdntExtIdentifier : Association to many RM.A_CustAddrDepdntExtIdentifier {  };
  to_CustAddrDepdntInformation : Association to many RM.A_CustAddrDepdntInformation {  };
  to_CustomerCompany : Association to many RM.A_CustomerCompany {  };
  to_CustomerSalesArea : Association to many RM.A_CustomerSalesArea {  };
  to_CustomerTaxGrouping : Association to many RM.A_CustomerTaxGrouping {  };
  to_CustomerText : Association to many RM.A_CustomerText {  };
  to_CustomerUnloadingPoint : Association to many RM.A_CustomerUnloadingPoint {  };
  to_CustUnldgPtAddrDepdntInfo : Association to many RM.A_CustUnldgPtAddrDepdntInfo {  };
};
...
entity RM.A_CustomerCompany {
  ...
  @sap.quickinfo : 'Customer Account Group'
  CustomerAccountGroup : String(4);
  to_CompanyText : Association to many RM.A_CustomerCompanyText {  };
  to_CustomerDunning : Association to many RM.A_CustomerDunning {  };
  to_WithHoldingTax : Association to many RM.A_CustomerWithHoldingTax {  };
};
...
entity RM.A_CustomerCompanyText {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Customer'
  @sap.quickinfo : 'Customer Number'
  key Customer : String(10) not null;
...
entity RM.A_CustomerSalesArea {
  ...
  @sap.quickinfo : 'Customer Account Group'
  CustomerAccountGroup : String(4);
  to_PartnerFunction : Association to many RM.A_CustSalesPartnerFunc {  };
  to_SalesAreaTax : Association to many RM.A_CustomerSalesAreaTax {  };
  to_SalesAreaText : Association to many RM.A_CustomerSalesAreaText {  };
  to_SlsAreaAddrDepdntInfo : Association to many RM.A_CustSlsAreaAddrDepdntInfo {  };
};
...
entity RM.A_CustomerSalesAreaTax {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Customer'
  @sap.quickinfo : 'Customer Number'
  key Customer : String(10) not null;
  ...
  to_SlsAreaAddrDepdntTax : Association to many RM.A_CustSlsAreaAddrDepdntTaxInfo {  };
};
...
entity RM.A_CustomerSalesAreaText {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Customer'
  @sap.quickinfo : 'Customer Number'
  key Customer : String(10) not null;
...
entity RM.A_CustomerTaxGrouping {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Customer'
  @sap.quickinfo : 'Customer Number'
  key Customer : String(10) not null;
...
entity RM.A_CustomerUnloadingPoint {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Customer'
  @sap.quickinfo : 'Customer Number'
  key Customer : String(10) not null;
...
entity RM.A_CustomerWithHoldingTax {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Customer'
  @sap.quickinfo : 'Customer Number'
  key Customer : String(10) not null;
...
entity RM.A_CustSalesPartnerFunc {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Customer'
  @sap.quickinfo : 'Customer Number'
  key Customer : String(10) not null;
...
entity RM.A_CustSlsAreaAddrDepdntInfo {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Customer'
  @sap.quickinfo : 'Customer Number'
  key Customer : String(10) not null;
...
entity RM.A_CustSlsAreaAddrDepdntTaxInfo {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Customer'
  @sap.quickinfo : 'Customer Number'
  key Customer : String(10) not null;
...
entity RM.A_CustUnldgPtAddrDepdntInfo {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Customer'
  @sap.quickinfo : 'Customer Number'
  key Customer : String(10) not null;
...
entity RM.A_Supplier {
  ...
  to_SupplierCompany : Association to many RM.A_SupplierCompany {  };
  to_SupplierPurchasingOrg : Association to many RM.A_SupplierPurchasingOrg {  };
  to_SupplierText : Association to many RM.A_SupplierText {  };
};
...
entity RM.A_SupplierCompany {
  ...
  @sap.quickinfo : 'Supplier Account Group'
  SupplierAccountGroup : String(4);
  to_CompanyText : Association to many RM.A_SupplierCompanyText {  };
  to_Supplier : Association to RM.A_Supplier {  };
  to_SupplierDunning : Association to many RM.A_SupplierDunning {  };
  to_SupplierWithHoldingTax : Association to many RM.A_SupplierWithHoldingTax {  };
};
...
entity RM.A_SupplierCompanyText {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Supplier'
  @sap.quickinfo : 'Account Number of Supplier'
  key Supplier : String(10) not null;
...
entity RM.A_SupplierPartnerFunc {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Supplier'
  @sap.quickinfo : 'Account Number of Supplier'
  key Supplier : String(10) not null;
...
entity RM.A_SupplierPurchasingOrg {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Supplier'
  ...
  @sap.quickinfo : 'Supplier Account Group'
  SupplierAccountGroup : String(4);
  to_PartnerFunction : Association to many RM.A_SupplierPartnerFunc {  };
  to_PurchasingOrgText : Association to many RM.A_SupplierPurchasingOrgText {  };
};
...
entity RM.A_SupplierPurchasingOrgText {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Supplier'
  @sap.quickinfo : 'Account Number of Supplier'
  key Supplier : String(10) not null;
...
entity RM.A_SupplierWithHoldingTax {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Supplier'
  @sap.quickinfo : 'Account Number of Supplier'
  key Supplier : String(10) not null;
