...
let riskapps_styles_styles_light_css = __webpack_require__(/*! ./RISKAPPS/Styles/Styles.light.css */ "./build.definitions/RISKAPPS/Styles/Styles.light.css")
let riskapps_styles_styles_light_json = __webpack_require__(/*! ./RISKAPPS/Styles/Styles.light.json */ "./build.definitions/RISKAPPS/Styles/Styles.light.json")
let riskapps_styles_styles_light_nss = __webpack_require__(/*! ./RISKAPPS/Styles/Styles.light.nss */ "./build.definitions/RISKAPPS/Styles/Styles.light.nss")
...
module.exports = {
	...
	riskapps_styles_styles_light_css : riskapps_styles_styles_light_css,
	riskapps_styles_styles_light_json : riskapps_styles_styles_light_json,
	riskapps_styles_styles_light_nss : riskapps_styles_styles_light_nss,
...
function DeleteConfirmation(clientAPI) {
  return clientAPI.executeAction('/RISKAPPS/Actions/DeleteConfirmation.action').then(result => {
    if (result.data) {
      return clientAPI.executeAction('/RISKAPPS/Actions/riskmanagementService/Mitigations/Mitigations_DeleteEntity.action').then(success => Promise.resolve(success), failure => Promise.reject('Delete entity failed ' + failure));
    } else {
      return Promise.reject('User Deferred');
    }
  });
...
function DeleteConfirmation(clientAPI) {
  return clientAPI.executeAction('/RISKAPPS/Actions/DeleteConfirmation.action').then(result => {
    if (result.data) {
      return clientAPI.executeAction('/RISKAPPS/Actions/riskmanagementService/risks/risks_DeleteEntity.action').then(success => Promise.resolve(success), failure => Promise.reject('Delete entity failed ' + failure));
    } else {
      return Promise.reject('User Deferred');
    }
  });
...
/***/ "./build.definitions/RISKAPPS/Styles/Styles.light.css":
/*!************************************************************!*\
  !*** ./build.definitions/RISKAPPS/Styles/Styles.light.css ***!
  \************************************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {
...
/***/ "./build.definitions/RISKAPPS/Styles/Styles.light.nss":
/*!************************************************************!*\
  !*** ./build.definitions/RISKAPPS/Styles/Styles.light.nss ***!
  \************************************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {
...
module.exports = {"_Name":"RISKAPPS","Version":"/RISKAPPS/Globals/Application/AppDefinition_Version.global","MainPage":"/RISKAPPS/Pages/Main.page","OnLaunch":"/RISKAPPS/Rules/Service/Initialize.js","OnWillUpdate":"/RISKAPPS/Rules/Application/OnWillUpdate.js","OnDidUpdate":"/RISKAPPS/Rules/Service/Initialize.js","Styles":"/RISKAPPS/Styles/Styles.css","Localization":"/RISKAPPS/i18n/i18n.properties","_SchemaVersion":"24.11","StyleSheets":{"Styles":{"css":"/RISKAPPS/Styles/Styles.light.css","ios":"/RISKAPPS/Styles/Styles.light.nss","android":"/RISKAPPS/Styles/Styles.light.json"}},"SDKStyles":{"ios":"/RISKAPPS/Styles/Styles.light.nss","android":"/RISKAPPS/Styles/Styles.light.json"}}
...
/***/ "./build.definitions/RISKAPPS/Styles/Styles.light.json":
/*!*************************************************************!*\
  !*** ./build.definitions/RISKAPPS/Styles/Styles.light.json ***!
  \*************************************************************/
/***/ ((module) => {
